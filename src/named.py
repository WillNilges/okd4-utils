...
def main():
    ...
    print("Let's generate a named config.")
    print("First up, I need domain information.")

    domain = input("What is your domain? \n > ")
    sub_domain = input("And what sub-domain will your cluster be installed on? \n > ")
    print("Setting domain to {}.{}.".format(sub_domain, domain))

    print("Rad, now what are your bootstrap details?")
    bootstrap = enter_details(1)

    bootstrap_ip = list(bootstrap.values())[0]
